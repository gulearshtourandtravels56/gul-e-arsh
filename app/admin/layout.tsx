  ...
  return (
    <div className="flex min-h-screen bg-linear-to-br from-gray-50 to-gray-100 overflow-hidden">
      ...
      <aside
        ...
        } bg-linear-to-b from-slate-950 via-slate-900 to-slate-800 text-white transition-all duration-300 fixed h-screen flex flex-col shadow-2xl z-40`}
      >
        {/* Header */}
      ...
      {/* Main Content */}
      <main className={`${sidebarOpen ? 'ml-72' : 'ml-20'} flex-1 transition-all duration-300 flex flex-col`}>
